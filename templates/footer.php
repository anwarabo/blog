...
<!-- Footer-->
<footer class="border-top" style="background-color: #E5E4E2;">
            <div class="container px-4 px-lg-5">
                <div class="row gx-4 gx-lg-5 justify-content-center">
                    <div class="col-md-10 col-lg-8 col-xl-7">
                        ...
                        <div class="small text-center text-muted fst-italic"><?php echo $settings_record['footer'] ?? 'Copyright &copy; Your Website 2023' ?></div>
                    </div>
                </div>
            </div>
        </footer>
